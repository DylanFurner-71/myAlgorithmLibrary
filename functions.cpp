...
template <typename T>
void functions::mergeSort(T* toSearch, int size){
...
template <typename T>
void functions::quickSort(T* toSearch, int size){
    quickSortAlgo(toSearch, 0, size-1);
}
template <typename T>
void functions::insertionSort(int size, T* toSearch, T search){
    std::map<int, int> mp;
...
template <typename T>
int functions::linearSearch(T* data, T searchNumber, int size){
    for (int i = 0; i < size; i++) {
...
template <typename T>
int functions::binarySearch(T* arr, int l, int r, T target){
...
template <typename T>
int functions::exponentialSearch(T* arr, int n, int x, int size){
